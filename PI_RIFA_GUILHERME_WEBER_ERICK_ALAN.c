...
int autenticarPessoa(char email[], char senha[]){	
	...
	for(i=0; i < TAM;i++){		
		...
		if (igual == 0){ // achou o apelido igual ao digitado no vetor
			igual = strcmp(pessoas[i].senha, senha);
			if (igual == 0){ // achou a senha igual
...
void errocadastro(){	
	printf("O que foi colocado não é oque foi pedido");	
}	
...
void TelaCadastroADM(){
    ...
    printf("*                                                                            *\n");
    printf("*                              Bem-Vindo!....                                *\n");
    printf("*    Entre com as informações necessárias para fazer o cadastro de ADM:      *\n");
    printf("*                                                                            *\n");
    printf("* Digite o seu Nome (Somente Letras)  [                           ]          *\n"); 
    printf("*                                                                            *\n"); 
    printf("* Digite o seu Email                  [                           ]          *\n");
    printf("*                                                                            *\n");  
    printf("* Crie uma senha (Somente números)           [             ]                 *\n");
    printf(" **************************************************************************** \n");
}
...
void TelaCadastro(){
    ...
    printf("*                                                                            *\n");
    printf("*                                                                            *\n");
    printf("*    Entre com as informações necessárias para realizar o cadastro:          *\n");
    printf("*                                                                            *\n");
    printf("* Digite o seu email [                         ]                             *\n"); 
    printf("*                                                                            *\n"); 
...
void TelaLogin(){
    ...
    printf("*                                                                            *\n");
    printf("*                                                                            *\n");
    printf("*    Entre com as informações necessárias para realizar o login:             *\n");
    printf("*                                                                            *\n");
    printf("* Digite o seu email[                         ]                              *\n"); 
    printf("*                                                                            *\n"); 
...
void TelaInicio(){
	...
	printf("*                                                                            *\n");
	printf("*                                                                            *\n");
	printf("*          Por favor selecione a opção que se refere a quem voce e:          *\n");  
	printf("*                                                                            *\n");
...
void TelaADM1(){
	...
	printf("*                                                                            *\n");
	printf("*                                                                            *\n");
	printf("*      Olá Administrador! Por favor, Selecione o que deseja realizar...      *\n");  
	printf("*                                                                            *\n");
	printf("*                           [ ] Cadastrar Prêmios                            *\n"); 
...
main(){
	...
	do{//volta do menu de numeros
	
		do{ //sair do menu usuario
		do{ //sair do adm
		menuadmsair=0;
			...
			if (linha == 13){	// menu de adm	
				...
				if (linha == 13){  // selecionou cad premio	
					...
					printf("*                                                                            *\n");
					printf("*                                                                            *\n");
					printf("* Digite o 1° Prêmio á Cadastrar:                                            *\n");  
					printf("*                                                                            *\n");
					printf("* Digite o 2° Prêmio á Cadastrar:                                            *\n");
					printf("*                                                                            *\n");
					printf("* Digite o 3° Prêmio á Cadastrar:                                            *\n");
					printf("*                                                                            *\n"); 
					printf("* Digite o 4° Prêmio á Cadastrar:                                            *\n"); 
					printf("*                                                                            *\n");
					printf("* Digite o 5° Prêmio á Cadastrar:                                            *\n");  
					printf(" **************************************************************************** \n");
					...
					gotoxy(8,8);
					printf("\n Os premios cadastrados foram: 1º %s\n, \t\t\t       2º %s\n, \t\t\t       3º %s\n, \t\t\t       4º %s\n, \t\t\t       5º %s", pre1,pre2,pre3,pre4,pre5);
					sleep(3);
					cadpremio=1;// novo
					menuadmsair=1;
					
				}
				if (linha == 14){  // sortear os numeros
						...
						if(OK==1){
					   	...
					   	if (matrizstats[numer1][numer2] == 2){
							...
							if (cadpremio == 1){
								if (contsort == 0){
								gotoxy(5,10);
								printf("\n* 1° Prêmio: %s - Número Sorteado: [%i] Vencedor [%s]", pre1, matriztests[numer1][numer2], pessoas[c].nome);
								}
								if (contsort == 1){
								gotoxy(5,11);
								printf("\n* 2° Prêmio: %s - Número Sorteado: [%i] Vencedor [%s]", pre2, matriztests[numer1][numer2], pessoas[c].nome);
								}	
								if (contsort == 2){
								gotoxy(5,12);
								printf("\n* 3° Prêmio: %s - Número Sorteado: [%i] Vencedor [%s]", pre3, matriztests[numer1][numer2], pessoas[c].nome);
								}
								if (contsort == 3){
						 		gotoxy(5,13);
								printf("\n* 4° Prêmio: %s - Número Sorteado: [%i] Vencedor [%s]", pre4, matriztests[numer1][numer2], pessoas[c].nome);
								}
								if (contsort == 4){
								gotoxy(5,14);
								printf("\n* 5° Prêmio: %s - Número Sorteado: [%i] Vencedor [%s]", pre5, matriztests[numer1][numer2], pessoas[c].nome);
								}
							}
							...
							if (cadpremio == 0){
								if (contsort == 0){	
								gotoxy(5,10);
								printf("\n* 1° Número Sorteado: [%i] Vencedor [%s]", matriztests[numer1][numer2], pessoas[c].nome);
								
								}
								if (contsort == 1){
								gotoxy(5,11);
								printf("\n* 2° Número Sorteado: [%i] Vencedor [%s]", matriztests[numer1][numer2], pessoas[c].nome);
								
								}	
								if (contsort == 2){
								gotoxy(5,12);
								printf("\n* 3° Número Sorteado: [%i] Vencedor [%s]", matriztests[numer1][numer2], pessoas[c].nome);
								
								}
								if (contsort == 3){
								gotoxy(5,13);
								printf("\n* 4° Número Sorteado: [%i] Vencedor [%s]", matriztests[numer1][numer2], pessoas[c].nome);
								
								}
								if (contsort == 4){
								gotoxy(5,14);
								printf("\n* 5° Número Sorteado: [%i] Vencedor [%s]", matriztests[numer1][numer2], pessoas[c].nome);
		...
		{  
			...
			if (linha == 14){		
				...
				while (tecla != 13){  
    				...
    				TelaLoginCadastro(); // Tela com as opções de loguin e cadastro
				...
				if (linha == 13){	
					...
					if (autenticado == 0){  //NAO DEU CERTO apelido e senha
						system("cls");
		...
		do{//enquanto n pedir pra sair ele roda

		do{//while (tecla != 49 || tecla != 50 || tecla != 48)	
		...
		if(tecla == 49){//alugar
			...
			if((OK1 == 1) && (OK2 == 1)){
				...
				printf("ERRO, o numero selecionado não esta disponivel ou ja foi alugado por você");
		...
		if(tecla == 50){//comprar
			...
			if((OK1 == 1) && (OK2 == 1)){
				...
				printf("ERRO, o numero selecionado não esta disponivel");
